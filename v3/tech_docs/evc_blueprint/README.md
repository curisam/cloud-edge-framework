...
- 이종의 에지 장치(edge device)들간의 유기적인 연동 지원은 EVC의 핵심 목표 중의 하나입니다.

- 이를 위해 연동 프로파일을 정의했으며, EVC 서버를 포함한 에지 장치들이 서로 연결됩니다.
...
- 따라서 응용 서비스의 목적에 따라 연동 프로파일을 선택하고, 연동 프로파일에 따른 절차에 따라 연동방식을 적용하면 됩니다.
...
- EVC는 다양한 공개소스 프로젝트들을 활용했으며, 핵심 구현 요소들을 기술하면 다음과 같습니다.
